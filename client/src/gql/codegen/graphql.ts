...
export type GetAllMessagesQuery = { __typename?: 'Query', getAllMessages?: Array<{ __typename?: 'Message', content: string, senderID: string, receiverID: string, createdAt: string } | null> | null };
